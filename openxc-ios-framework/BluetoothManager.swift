...
//
//  Created by Ranjan, Kumar sahu (K.) on 29/01/18.
...
open class BluetoothManager: NSObject,CBCentralManagerDelegate,CBPeripheralDelegate {
    ...
    open func connect(_ name:String) {
        ...
        if VehicleManager.sharedInstance.connectionState != .scanning {
        ...
        VehicleManager.sharedInstance.connectionState = .connectionInProgress
    ...
    open func scan(completionHandler: @escaping (_ success: Bool) -> ()) {
        ...
        if VehicleManager.sharedInstance.connectionState != .notConnected {
        ...
        VehicleManager.sharedInstance.connectionState = .scanning
        messageCount = 0
    ...
    open func centralManagerDidUpdateState(_ central: CBCentralManager) {
        ...
        if central.state == .poweredOn && VehicleManager.sharedInstance.connectionState == .scanning {
    ...
    open func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        VehicleManager.sharedInstance.connectionState = .connected
    ...
    open func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
        ...
        for characteristic in service.characteristics! {
            ...
            if characteristic.uuid.uuidString == OpenXCConstants.C5_OPENXC_BLE_CHARACTERISTIC_NOTIFY_UUID {
                ...
                VehicleManager.sharedInstance.connectionState = .operational
            }
    ...
    open func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor characteristic: CBCharacteristic, error: Error?) {
        ...
        if TraceFileData.sharedInstance.traceFilesourceEnabled {return}
